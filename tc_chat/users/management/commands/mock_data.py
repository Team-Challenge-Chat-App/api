...
from tc_chat.users.models import Group, User
...
def create_mock_data():
    ...
    # Create users
    user_data = [
        {"username": "alice", "email": "alice@example.com", "password": "securepassword123", "groups": ["IT", "Cooking"]},
        {"username": "bob", "email": "bob@example.com", "password": "securepassword123", "groups": ["Sport"]},
        {"username": "carol", "email": "carol@example.com", "password": "securepassword123", "groups": ["Cooking", "Sport"]},
    ]
    ...
    for name in group_names:
        ...
        group, created = Group.objects.get_or_create(
            name=name, 
            defaults={'is_dev_created': True, 'creator': creator}
        )
        if created:
